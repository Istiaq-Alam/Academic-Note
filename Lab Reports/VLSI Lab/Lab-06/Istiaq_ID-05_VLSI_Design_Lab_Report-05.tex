...
\end{figure}
\newpage
\subsection*{Output Diagram}
\begin{figure}[!h]
\centering
\includegraphics[width=1\textwidth]{Inverter-Out.png}
\caption{Output of Inverter (NOT Gate)}
\end{figure}
...
\caption{Output of 2in-NAND Gate}
\end{figure}
...
\caption{Output of 2in-NOR Gate}
\end{figure}
...
% =====================================================
\section{Conclusion}
From the implementation and simulation of stick diagrams using Microwind2, it was observed that the layout structures of the 2-input NAND gate, 2-input NOR gate, and inverter correctly represent their respective CMOS configurations. The arrangement of polysilicon, diffusion, and metal layers follows standard VLSI design conventions, ensuring proper formation of transistor networks.\\
