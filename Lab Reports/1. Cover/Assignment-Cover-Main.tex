...
\begin{center}
    ...
    \vspace{0.9cm}
    \textbf{\Huge \underline{VLSI Design Assignment-01}} \\
    
    \vspace{1.5em}
    \begin{flushleft}
    	\textbf{\Large Course Code: CSE-4217} \\
		\vspace{0.3cm}        
        \textbf{\Large Course Title: VLSI Design} \\
        \vspace{0.3cm}
        \textbf{\Large Assignment Topic: New Trends in VLSI Design} \\        
    \end{flushleft}
